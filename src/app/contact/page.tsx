...
export default function ContactPage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative py-20 bg-gray-900 text-white overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-20">
          ...
          <div className="absolute top-1/3 right-1/4 w-1/3 h-1/3 border border-white/10 rounded-lg"></div>
          <div className="absolute bottom-1/4 left-1/3 w-1/4 h-1/4 border border-white/10 rounded-lg"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Your vision is the blueprint. Let's collaborate to transform it into an architectural masterpiece.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          {/* Contact Information - Architectural Style Card */}
  ...
  <div>
    ...
    <div className="space-y-1 text-gray-600">
      ...
      <p>
        <a href="tel:+919650058444" className="hover:text-red-600 transition-colors duration-300">
          +91-96500 58444
        </a>
      </p>
    </div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-100">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">Studio Hours</h3>
              ...
              <div className="mt-8 pt-8 border-t border-gray-100">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Follow Our Work</h3>
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-red-100 hover:text-red-600 transition-colors duration-300">
        ...
        <div className="mb-20">
          ...
          <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
            <iframe
              ...
              title="ARC 11 ARCHITECT Studio Location"
