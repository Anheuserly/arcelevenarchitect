...
export const metadata = {
  title: "Our Expertise - ARC 11 ARCHITECT | Architecture & Interior Design",
  description:
  ...
  alternates: { canonical: "https://www.arcelevenarchitect.com/expertise" },
};
    ...
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-extrabold text-gray-900">Our Expertise</h1>
