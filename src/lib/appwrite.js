...
export const COLLECTIONS = {
  ...
  ESTIMATOR_SUBMISSIONS: process.env.NEXT_PUBLIC_APPWRITE_ESTIMATOR_SUBMISSIONS_COLLECTION_ID || "",
  ESTIMATOR_TEMPLATES: process.env.NEXT_PUBLIC_APPWRITE_ESTIMATOR_TEMPLATES_COLLECTION_ID || "",
  ESTIMATOR_RATES: process.env.NEXT_PUBLIC_APPWRITE_ESTIMATOR_RATES_COLLECTION_ID || "",
  ESTIMATOR_CURRENCY_RATES:process.env.NEXT_PUBLIC_APPWRITE_ESTIMATOR_CURRENCY_RATES_COLLECTION_ID || "",
};
...
export const BUCKETS = {
  ...
  PARTNERS_DOCS: process.env.NEXT_PUBLIC_APPWRITE_PARTNERS_DOCS_BUCKET_ID || '',
   ESTIMATOR_ATTACHMENTS: process.env.NEXT_PUBLIC_APPWRITE_ESTIMATOR_ATTACHMENTS_BUCKET_ID || "",
};
